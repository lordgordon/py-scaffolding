...
DOCKER_BASE_IMAGE=python:3.11.12-slim-bullseye
PYSETUP_PATH=/app
DOCKER_IMAGE_NAME=py-scaffolding
DOCKER_LOCAL_TAG=current-local
RUN_DOCKER_BUILD := docker buildx build --build-arg DOCKER_BASE_IMAGE=${DOCKER_BASE_IMAGE} --build-arg PYSETUP_PATH=${PYSETUP_PATH} -f Dockerfile
